...
namespace Backend_PcAuction.Migrations
{
    ...
    [Migration("20240418171805_Addded address, phone nr, bank details to user entity")]
    partial class Adddedaddressphonenrbankdetailstouserentity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backend_PcAuction.Data.Entities.Purchase", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<DateTime>("AuctionWinDate")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Backend_PcAuction.Data.Entities.StripePayment", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Backend_PcAuction.Data.Entities.Purchase", b =>
                {
                    ...
                    b.HasOne("Backend_PcAuction.Auth.Model.User", "Buyer")
                        .WithMany()
            ...
            modelBuilder.Entity("Backend_PcAuction.Data.Entities.StripePayment", b =>
                {
                    b.HasOne("Backend_PcAuction.Data.Entities.Purchase", "Purchase")
                        .WithMany()
